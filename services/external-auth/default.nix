...
let
  options = {
    afraPublicExposedVirtualHosts = lib.mkOption {
  ...
  allOtherModules = extendModules {
    modules = [
      ...
      # we need the options defined in this case as well
      { inherit options; }
    ];
  };
    ...
    services.nginx.virtualHosts = lib.mapAttrs' (
      ...
      lib.nameValuePair "public-${name}" {
        ...
        locations = lib.mkMerge (
          ...
          ++ lib.optional (name == "id.afra-berlin.eu" && !(builtins.elem name config.afraPublicExposedVirtualHosts)) {
        ...
        extraConfig = lib.mkMerge (
          ...
          ++ lib.optional (name != "id.afra-berlin.eu" && name != "vouch.afra-berlin.eu" && !(builtins.elem name config.afraPublicExposedVirtualHosts)) ''
